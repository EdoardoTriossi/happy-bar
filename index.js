  ...
  <div class="row">
    ...
    <div class="col">
      <p>
        Mounting Phase:
        <ul> 
          <li>constructor(): Inizializzare il componente, settare lo stato iniziale e i vincoli. </li>
          <li>componentWillMount(): Deprecato, chiamato prima che il componente venga eseguito per la prima volta.</li>
          <li>render(): Eseque i componenti della UI. </li>
          <li>componentDidMount(): Invocato dopo che il componente é stato e seguito per la prima volta. Usato per effetti secondari come il recupero dei dati o interazioni con il DOM.</li>
        </ul>
      </p>
    </div>
    <div class="col">
      <p>
        Updating Phase:         
        <ul> 
          <li>componentWillReceiveProps(nextProps): Deprecato, chiamato quando il componente riceve nuove proprietá prima di aggiornarsi. </li>
          <li>shouldComponentUpdate(nextProps, nextState): Determina se il componete debba aggiornarsi, migliorando le prestazioni prevenendo esecuzioni inutili. </li>
          <li>componentWillUpdate(nextProps, nextState): Deprecato, chiamato prima che il componente di aggiorni. </li>
          <li>render(): Ricarica la UI del componente con lo stato e le proprietá aggiornate. </li>
          <li>componentDidUpdate(prevProps, prevState): Invocato dopo che il componente si a aggiorna. Usato per gli effetti secondari dopo l'aggiornamento.</li>
        </ul>
      </p>
    </div>
    <div class="col">
      <p>
        Unmounting Phase: 
        <ul>
        <li>componentWillUnmount(): Invocato prima che un componente sia rimosso dal DOM. Usata per i metodi di pulizia quando rimuovono event listeners.</li>
        </ul>
      </p>
    </div>
  </div>
...
const Issues = {
  ...
  <section class="document">
    ...
    <div class="row">
      ...
      <div class="col">
        <h3>Quale é l'obbiettivo dell'optional chaining operator in React?</h3>
        ...
        <div class="collapse" id="risposta10">
          <p>
            L'optinal chainig operator in React permette di accedere a proprietá di un oggetto o elemento di un orray senza causare un
            errore se l'oggeto o l'array é indefinito o nullo.
          </p>
        </div>
      </div>
      <div class="col">
        <h3>Perché si raccomanda di usare l'approccio functional update quando si aggiornano gli stati di React?</h3>
        ...
        <div class="collapse" id="risposta11">
          <p>
            E' raccomandato l'uso del approccio functional update quando si aggiornano gli stati di React per
      ...
      <div class="col">
        <h3>Qualo é lo scopo dei React hooks nella gestione degli stati?</h3>
        ...
        <div class="collapse" id="risposta12">
          <p>
            I React hooks, in particolare useState, rendono facile la gestione degli stati in React perché permettono la creazione di una variabile di stato, la sua set function, e lo stato
    ...
    <div class="row">
      <div class="col">
        <h3>Come si aggiornano efficentemente multiple proprietá di un oggetto di stato in React?</h3>
        ...
        <div class="collapse" id="risposta13">
          <p>
            Per aggiornare efficentemente multiple proprietá di un
      ...
      <div class="col">
        <h3>Quale é il problema potenziale dell'aggiornare direttamente uno stato in React senza ritornare un oggetto?</h3>
        ...
        <div class="collapse" id="risposta14">
          <p>
            Il problema potenziale del aggiornare
      ...
      <div class="col">
        <h3>Perché é vantagioso usare un singolo useState hook per input multipli in React?</h3>
        ...
        <div class="collapse" id="risposta15">
          <p>
            Usare un singolo useState hook
      ...
      <div class="col">
        <h3>Quando si dovrebbe considerare l'uso di useReducer invece di useState in React?</h3>
        ...
        <div class="collapse" id="risposta16">
          <p>
            Bisognerebbe considerare l'uso di useReducer invece di useState in React quando si ha uno state
    ...
    <div class="row">
      <div class="col">
        <h3>Quale é l'importanza di inizializzare stati correttamente in React?</h3>
        ...
        <div class="collapse" id="risposta17">
          <p>
            Inizializzare stati correttamente in React é importante per prevenire problemi
      ...
      <div class="col">
        <h3>
          Quale é il potenziale problema dell'immagazzinare un nuovo oggetto invece dell'id quando si derivano gli
          stati in React?
        </h3>
        ...
        <div class="collapse" id="risposta18">
          <p>
            Il potenziale problema dell'immagazzinare un nuovo oggetto invece dell'id quando si derivano stati in React é che gli stati derivati potrebbero non riflettere i cambiamneti fatti allo stato
            ...
            immagazzinare l'id dell'oggetto e recuperare l'oggetto usando l'id quando serve.
          </p>
        </div>
      </div>
    </div>
